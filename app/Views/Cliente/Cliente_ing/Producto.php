    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-light border-right" id="sidebar-wrapper">
            ...
            <?php if (session('cart')): ?>
              ...
              <?php endif; ?>
                <li class="list-group-item list-group-item-action bg-light">
                    <a href="/Clientes/carrito"><button type="button" class="btn botoncolor btn-block">See car</button></a>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a class="btn-link" href="/Clientes/tienda/<?php echo $producto['categoria']['id_categoria']; ?>"><?php echo $producto['categoria_ing']['nombre_ing']; ?></a></li>
                            ...
                            <div class="row">
                                <div class="col-md-12 text-justify">
                                    <p style="color: rgba(72,197,57); font-size: 1.4rem" class="mt-3">Stock: <?php echo $producto['stock'] ?></p>
                                    <p style="color:black; font-size: 1.3rem /* width and color */"><?php echo $producto['descripcion_ingles'] ?></p>
                                ...
                                <?php if (session('region') == 1): ?>
                                    ...
                                    <?php else: ?>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <button type="button" disabled class="btn botoncolor btn-lg btn-block">Not available</button>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                <?php else:?>
                        ...
                        <div class="mt-5 ml-2" style="text-align:center;">
                          <p><span><i class="icon-hecho-me-lines-01 " style="font-size:50px;" aria-hidden="true"></i></span>
                              ...
                              <!-- Solo aceites -->
                              <?php if ($producto['categoria']['id_categoria'] == 1): ?>
                          ...
                          <p class="pl-2 pr-2 text-justify textos" style="font-style: italic;">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>
                      </div>
                    </div>
                    ...
                    <?php if ($productos) : ?>
                        <div class="row mt-5">
                            <div class="container my-5 wow animate__animated animate__fadeInLeft">
                                <h1 class="font-weight-light text-center pb-3 mb-5">Other products</h1>
                                    ...
                                    <div class="card-deck">
                                        <?php foreach ($productos as $obj) : ?>
                                            <div class="card text-center">
                                                ...
                                                <div class="card-body">
                                                    <a href="/Clientes/producto/<?php echo $obj['id_producto'];?> "><h5 class="card-title"><strong><?php echo $obj['nombre']; ?></strong></h5></a>
                                                    <p class="card-text" style="font-style: italic;"><?php echo $obj['descripcion_ingles']; ?></p>
                                                    <?php if (session('region') == 1): ?>
                                                      <p class="card-text"><b><strong><?php echo $obj['precio'] ?></strong></b></p>
                                                    <?php endif; ?>
                                                    <!-- padecimientos -->
                                                    ...
                                                    <!-- fin de padecimientos -->
                                                        <?php if (session('region') == 1): ?>
                                                            ...
                                                            <?php else: ?>
                                                                <button class="btn botoncolor" disabled>Not available</button>
                                                            <?php endif; ?>
                                                        <?php else:?>
                                                            <a class="btn botoncolor" onclick="ver_colaboradores()">See Collaborators</a>
                                                        <?php endif; ?>
