    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Dosis</h5>
                            ...
                            <div class="carousel-item active">
                                <div class="card mb-4 pt-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">La dosis es: <b><?php echo $dosis[0]['resultado']; ?></b><br>*<?php echo $dosis[0]['subir']; ?></p>
                                        <?php if (session('usuario')): ?>
                                            <a href="#" class="btn btn-primary" onclick="guardar('<?php echo $dosis[0]['dosis']; ?>')">Guardar Dosis</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="carousel-item">
                                    <div class="card mb-4 pt-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text">La dosis es: <b><?php echo $dosis[$i]['resultado']; ?></b><br>*<?php echo $dosis[$i]['subir']; ?></p>
                                            <?php if (session('usuario')): ?>
                                                <a href="#" class="btn btn-primary" onclick="guardar('<?php echo $dosis[$i]['dosis']; ?>')">Guardar Dosis</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
