...
<body>
  ...
  <?php echo view('Cliente/Cliente_ing/Inicio'); ?>
  ...
  <?php if (session('region') < 3 || session('region') == 4): ?>
        ...
        <div class="container colorjumbotron borderr">
          <div class="row text-dark wow animate__animated animate__fadeIn">
            <div class="col-md-12">
              ...
              <strong><p class="text-center" style="color:black; font-size: 2.5rem /* width and color */">SOLUCIONES ALTERNATIVAS<br> ¡VIVE BIEN, SIÉNTETE BIEN!</p></strong>
            </div>
          </div>
    ...
    <div class="jumbotron jumbotron-fluid wow animate__animated animate__fadeIn">
      <div class="container">
        ...
        <p class="lead textos">Nankö es una Asociación Cannábica Mexicana con ocho años de experiencia en el mercado de medicina alternativa. La cual nace de la búsqueda de opciones para mejorar la calidad de vida siendo una alternativa segura y eficaz para cuidar la salud de toda la familia ofreciéndoles una opción 100% natural.</p>
      </div>
    </div>
    <!-- fin de jumbotron -->
    ...
    <?php if ($padecimientos): ?>
      <div class="container pb-3 text-center wow animate__animated animate__slideInUp ">
        <h2 class="font-weight-light pb-5"><strong>Padecimientos</strong></h2>
        <div class="row mx-auto my-auto">
