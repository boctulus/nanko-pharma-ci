                  ...
                  <div class="card active colorjumbotron pt-3 pb-3 pr-3 pl-3 borderr">
                    ...
                    <div class="row ">
                      <div class="col-md-8 col-sm-3 col-xs-3 mt-2">
                        ...
                        <input type="number" autocomplete="off" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" maxlength="16" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" data-openpay-card="card_number" class="form-control" style="max-width:50%"required />
                      </div>
                    </div>
                    <div class="row mt-2">
                      <div class="col-md-3 col-sm-3 col-xs-3 pr-5">
                        <span class="help-block small-font"><strong>Mes expiración</strong></span>
                        <input type="number" class="form-control" placeholder="MM" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" size="2" data-openpay-card="expiration_month" required />
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3  pr-5">
                        <span class="help-block small-font"><strong>Año expiración</strong></span>
                        <input type="number" class="form-control" placeholder="YY" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" maxlength="2" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" size="2" data-openpay-card="expiration_year" required />
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3 pr-5">
                        <span class="help-block small-font"><strong>CCV</strong> </span> <//img src="/assets/openpay/cvv.png"  style="max-width:10%" />
                        <input type="number" class="form-control" autocomplete="off" onkeydown="javascript: return event.keyCode === 8 || event.keyCode === 46 ? true : !isNaN(Number(event.key))" maxlength="4" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" data-openpay-card="cvv2" placeholder="CCV" required />
...
<!-- Footer -->
  ...
  function levantar_orden() {
    $("#levantar_orden").prop("disabled", true);
    $.ajax({
      async: true,
      cache: false,
      dataType: "html",
      type: 'POST',
      url: '<?php echo base_url('Clientes/levantar_orden'); ?>',
