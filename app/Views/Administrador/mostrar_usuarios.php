...
<!-- <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns"> -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l12">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Usuarios</span></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col s12">
                <div class="container">
                    ...
                    <section class="users-list-wrapper section">
                        <!-- Modal Trigger -->
                        <a class="waves-effect waves-light btn modal-trigger" href="#nuevo">Nuevo Usuario</a>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="responsive-table">
                                        <table id="lista" class="table">
                                            ...
                                            <tbody>
                                                <?php $i=0;foreach ($login as $obj): ?>
                                                    <tr>
                                                        <td><a><?php echo $obj['nombre'] ?></a>
                                                        </td>
                                                        ...
                                                        <td><a href="#" onclick="editar('<?php echo $obj['id_login'];?>',<?= $i; ?>)"><i class="material-icons">edit</i></a></td>
                                                        <td id="op_<?= $i; ?>">
                                                            <?php if ($obj['estado'] == "Activo"): ?>
                                                                <a href="#" onclick="eliminar('<?php echo $obj['id_login'];?>',<?= $i; ?>)"><i class="material-icons">delete</i></a>
                                                            <?php endif; ?>
                                                            <?php if ($obj['estado'] == "Eliminado"): ?>
                                                                <a href="#" onclick="reactivar('<?php echo $obj['id_login'];?>',<?= $i; ?>)"><i class="material-icons">add_circle_outline</i></a>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                    <?php $i++; ?>
    ...
    function eliminar(id,num){
        Swal.fire({
        title: '¿Seguro de desactivar al usuario?',
        ...
        if (result.value) {
            ...
            dataType:"html",
            type: 'POST',
            url: '<?php echo base_url('Usuarios/eliminar_usuario'); ?>',
            data: {id_user:id},
            success:  function(data){
                if(data){
    ...
    function reactivar(id,num){
        Swal.fire({
        title: '¿Seguro de reactivar al usuario?',
        text: "El usuario podrá volver acceder al sistema.",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#d33',
        cancelButtonColor: '#3085d6',
        confirmButtonText: 'Reactivar'
            ...
            if (result.value) {
                ...
                dataType:"html",
                type: 'POST',
                url: '<?php echo base_url('Usuarios/reactivar_usuario'); ?>',
                data: {id_user:id},
                success:  function(data){
                    if(data){
