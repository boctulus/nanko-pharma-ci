      ...
      <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <ul class="list-group list-group-flush" id="sidebar-cart">
          <?php if (session('cart')): ?>
              ...
              <li class="list-group-item list-group-item-action bg-light">
                <div class="row">
                  <div class="col-md-12 text-center">
                      <p>Partner discount: <?php echo session('usuario')['descuento']; ?>%</p>
                  </div>
                </div>
              </li>
              <li class="list-group-item list-group-item-action bg-light">
            ...
            <?php endif; ?>
              <li class="list-group-item list-group-item-action bg-light">
                <a href="/Clientes/carrito"><button type="button" class="btn btn-block  botoncolor" style="color:white;">See car</button></a>
                <?php if (session('usuario')): ?>
                  <a href="/Clientes/finalize_purchase"><button type="button" class="btn btn-dark btn-block mt-2">Finish Purchase</button></a>
                <?php else: ?>
                  <a onclick="aviso_sesion()"><button type="button" class="btn btn-dark btn-block mt-2">Finish Purchase</button></a>
                <?php endif; ?>
              </li>
          <?php endif; ?>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 woow animate__animated animate__fadeInTopLeft">
            ...
            <div class="list-group">
              <a href="/Clientes/tienda/" class="list-group-item btn-store border-down d-flex justify-content-center"  style="text-decoration: none; font-Size:25px; background-color:#0000;">All</a>

              <?php if ($categorias) : ?>
                <?php foreach ($categorias as $obj) : ?>
                  <?php if ($obj['id_categoria'] == 'MQ==') : ?>
                   <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group" style="font-size:4px;"><img src="/assets/Icontienda/gotero.svg" class="img-fluid" style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                  <?php if ($obj['id_categoria'] == 'Mg==') : ?>
                  <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group" style="font-size:4px;"><img src="/assets/Icontienda/010-oil.svg" class="img-fluid" style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                  <?php if ($obj['id_categoria'] == 'Mw==') : ?>
                  <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group" style="font-size:4px;"><img src="/assets/Icontienda/paw.png" class="img-fluid" style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                  <?php if ($obj['id_categoria'] == 'NA==') : ?>
                  <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group" style="font-size:4px;"><img src="/assets/Icontienda/gel.png" class="img-fluid" style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                  <?php if ($obj['id_categoria'] == 'NQ==') : ?>
                  <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group" style="font-size:4px;"><img src="/assets/Icontienda/suministros.png" class="img-fluid" style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                  <?php if ($obj['id_categoria'] == 'Ng==') : ?>
                  <a href="/Clientes/tienda/<?php echo $obj['id_categoria']; ?>" class="list-group-item btn-store border-down d-flex justify-content-start"  style="text-decoration: none; font-Size:25px; background-color:#00000;"><i class="mr-4 img-list-group " style="font-size:4px;"><img src="/assets/Icontienda/cosmeticos.png" class="img-fluid " style="max-width:30px"/></i><?php echo $obj['nombre_ing']; ?></a>
                  <?php endif; ?>
                <?php endforeach; ?>
              <?php endif; ?>
            </div>
              ...
              <?php foreach ($productos as $obj) : ?>
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card text-center h-100">
                    <a href="/Clientes/producto/<?php echo $obj['id_producto']; ?>"><img class="card-img-top" src="<?php echo $obj['img'] ?>" alt=""></a>
                    <div class="card-body">
                      <h4 class="card-title">
                        <a class="btn-link" href="/Clientes/producto/<?php echo $obj['id_producto']; ?>"><strong><?php echo $obj['nombre']; ?></strong></a>
                      </h4>
                      <h5>
                        <a class="btn-link" href="/Clientes/tienda/<?php echo $obj['categoria_ing']['id_categoria'] ?>"><?php echo $obj['categoria_ing']['nombre_ing']; ?></a>
                      </h5>
                      <?php if (session('region') == 1): ?>
                        <h5><strong><?php echo $obj['precio']; ?></strong></h5>
                      <?php endif; ?>
                      <p class="card-text truncate_text" style="font-style: italic;"><?php echo $obj['descripcion_ingles']; ?></p>
                        <!-- padecimientos -->
                      <div class="text-center mb-3">
                        ...
                        <?php if (session('region') == 1): ?>
                          <?php if ($obj['disp']): ?>
                            <a class="btn botoncolor" onclick="add_cart('<?php echo $obj['id_producto']; ?>')">Add to cart</a>
                          <?php else: ?>
                            <button class="btn botoncolor" disabled>Not aviable</button>
                          <?php endif; ?>
                        <?php else:?>
