...
<!-- <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns"> -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Testimonios</span></h5>
                        </div>
            ...
            <div class="col s12">
                <div class="container">
                    ...
                    <section class="users-list-wrapper section">
                        <!-- Modal Trigger -->
                        <a class="waves-effect waves-light btn modal-trigger" href="#nuevo">Nuevo Testimonio</a>
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="responsive-table">
                                        <table id="lista" class="table">
                                            ...
                                            <tbody>
                                                <?php $i=0;foreach ($testimonio as $obj): ?>
                                                    <tr>
                                                        <td>
                                                            <a>
                                                                <?php echo $obj['nombre'] ?>
                                                        ...
                                                        <td><a href="#" onclick="editar('<?php echo $obj['id_testimonio'];?>',<?= $i; ?>)"><i class="material-icons">edit</i></a></td>
                                                        <td id="op_<?= $i; ?>">
                                                            <?php if ($obj['estado'] == "Activo"): ?>
                                                                <a href="#" onclick="eliminar('<?php echo $obj['id_testimonio'];?>',<?= $i; ?>)"><i class="material-icons">delete</i></a>
                                                            <?php endif; ?>
                                                            <?php if ($obj['estado'] == "Eliminado"): ?>
                                                                <a href="#" onclick="reactivar('<?php echo $obj['id_testimonio'];?>',<?= $i; ?>)"><i class="material-icons">add_circle_outline</i></a>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                    <?php $i++; ?>
    ...
    <!-- modales -->
    <?php echo view("Administrador/Modal/nuevo_testimonio"); ?>
    <div id="modal"></div>
    ...
    function editar(id) {
        $.ajax({
            ...
            dataType:"html",
            type: 'POST',
            url: '<?php echo base_url('Testimonios/editar_testimonio'); ?>',
            data: {id_test:id},
    ...
    function eliminar(id,num){
        Swal.fire({
        title: '¿Seguro de desactivar al testimonio?',
        //text: "El testimonio será desactivado y no podrá acceder al sistema.",
        icon: 'warning',
        ...
        if (result.value) {
            ...
            dataType:"html",
            type: 'POST',
            url: '<?php echo base_url('Testimonios/eliminar_testimonio'); ?>',
            data: {id_test:id},
            success:  function(data){
                if(data){
    ...
    function reactivar(id,num){
        Swal.fire({
        title: '¿Seguro de reactivar al testimonio?',
        //text: "El testimonio podrá volver acceder al sistema.",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#d33',
        cancelButtonColor: '#3085d6',
        confirmButtonText: 'Reactivar'
            ...
            if (result.value) {
                ...
                dataType:"html",
                type: 'POST',
                url: '<?php echo base_url('Testimonios/reactivar_testimonio'); ?>',
                data: {id_test:id},
                success:  function(data){
                    if(data){
